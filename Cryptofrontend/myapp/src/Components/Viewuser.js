...
const Viewuser = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/getsingleprofile/${_id}`)
            ...
            <div className="col-md-8 mx-auto">
              <Card className="card border-dark mx-auto mt-5">
                <Card.Body className="h-100">
                  <h3>TRADERS DETAILS</h3>
                  <Card.Title> Name: {res.name}</Card.Title>
                  <Card.Text>Place: {res.place}</Card.Text>
                  <Card.Text>occupation: {res.occupation}</Card.Text>
                  <Card.Text>occupation: {res.age}</Card.Text>
